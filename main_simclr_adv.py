...
if args.data == "imagenet100" or args.data == "imagenet":
    ...
    train_dataset = load_dataset_simclr(args.data, train=True)
...
def main():
    for epoch in tqdm(range(args.epoch)): 
        ...
        for step, (data, label) in enumerate(dataloader):
            ...
            delta = pgd_linf(net, x2, 8/255, 1e-2, 5, criterion,label,args.method)#64/255 for CIFAR10 #8/255 for CIFAR100
            x_adv = (x2 + delta)
        ...
        if (epoch+1) % 100 == 0:
            model_dir = dir_name+"/save_models_adv_wo_Normalization_8_patch_0.75vs0.25_cifar100/"
